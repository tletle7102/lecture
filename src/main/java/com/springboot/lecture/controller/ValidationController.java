...
import com.springboot.lecture.data.dto.ValidRequestDto;
import com.springboot.lecture.data.dto.ValidatedRequestDto;
...
public class ValidationController {
    ...
    @PostMapping("/valid")
    public ResponseEntity<String> checkedValidationByValid(
